...
- ModeloArvoreDecisão.ipynb - Notebook principal contendo o código para a construção, treinamento e avaliação do modelo de árvore de decisão.

- dados/ - Diretório contendo os conjuntos de dados utilizados no experimento.

Pré-requisitos

- Antes de executar o notebook, certifique-se de ter instalado os seguintes pacotes Python:
